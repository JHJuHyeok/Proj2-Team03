Shader "AllIn1SpriteShader/AllIn1SpriteShader" {
	Properties {
		...
		_ColorChangeTolerance4 ("Tolerance 4", Range(0, 1)) = 0.25
		_ColorChangeTarget4 ("Color to change 4", Vector) = (1,0,0,1)
		[HDR] _ColorChangeNewCol4 ("New Color 4", Vector) = (1,1,0,1)
		_ColorChangeTolerance5 ("Tolerance 5", Range(0, 1)) = 0.25
		_ColorChangeTarget5 ("Color to change 5", Vector) = (1,0,0,1)
		[HDR] _ColorChangeNewCol5 ("New Color 5", Vector) = (1,1,0,1)
